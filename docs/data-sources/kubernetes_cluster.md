...
- `scale_policy` (List of Object) (see [below for nested schema](#nestedobjatt--master--scale_policy))
...
- `auto_scale` (List of Object) (see [below for nested schema](#nestedobjatt--master--scale_policy--auto_scale))
