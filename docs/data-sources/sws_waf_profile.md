...
- `action` (String)
- `core_rule_set` (List of Object) (see [below for nested schema](#nestedobjatt--rule_set--core_rule_set))
- `is_enabled` (Boolean)
- `ml_rule_set` (List of Object) (see [below for nested schema](#nestedobjatt--rule_set--ml_rule_set))
- `priority` (Number)
- `ya_rule_set` (List of Object) (see [below for nested schema](#nestedobjatt--rule_set--ya_rule_set))
...
- `inbound_anomaly_score` (Number)
- `paranoia_level` (Number)
- `rule_set` (List of Object) (see [below for nested schema](#nestedobjatt--rule_set--core_rule_set--rule_set))
...
- `rule_group` (List of Object) (see [below for nested schema](#nestedobjatt--rule_set--ml_rule_set--rule_group))
- `rule_set` (List of Object) (see [below for nested schema](#nestedobjatt--rule_set--ml_rule_set--rule_set))
...
- `rule_group` (List of Object) (see [below for nested schema](#nestedobjatt--rule_set--ya_rule_set--rule_group))
- `rule_set` (List of Object) (see [below for nested schema](#nestedobjatt--rule_set--ya_rule_set--rule_set))
