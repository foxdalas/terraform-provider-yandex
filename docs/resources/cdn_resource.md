...
//
// Example with URL rewrite for static website hosting
//
resource "yandex_cdn_resource" "static_website" {
  cname           = "www.example.com"
  origin_group_id = yandex_cdn_origin_group.s3_origin.id
  
  options {
    # Rewrite directory paths to serve index.html files
    rewrite {
      enabled = true
      body    = "^/(.*)/$ /$1/index.html"
      flag    = "break"
