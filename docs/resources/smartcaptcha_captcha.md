...
- `disallow_data_processing` (Boolean) If true, Yandex team won't be able to read internal data.
...
- `condition` (Block List) The condition for matching the rule. (see [below for nested schema](#nestedblock--security_rule--condition))
- `description` (String) Optional description of the rule. 0-512 characters long.
...
- `headers` (Block List) Captcha request headers. (see [below for nested schema](#nestedblock--security_rule--condition--headers))
- `host` (Block List) Host where captcha placed. (see [below for nested schema](#nestedblock--security_rule--condition--host))
- `source_ip` (Block List) The IP address of the requester. (see [below for nested schema](#nestedblock--security_rule--condition--source_ip))
- `uri` (Block List) URI where captcha placed. (see [below for nested schema](#nestedblock--security_rule--condition--uri))
...
- `value` (Block List) Value of the header. (see [below for nested schema](#nestedblock--security_rule--condition--headers--value))
...
- `hosts` (Block List) List of hosts. OR semantics implied. (see [below for nested schema](#nestedblock--security_rule--condition--host--hosts))
...
- `geo_ip_match` (Block List) package: yandex.cloud.smartcaptcha.v1
filename: yandex/cloud/smartcaptcha/v1/captcha.proto (see [below for nested schema](#nestedblock--security_rule--condition--source_ip--geo_ip_match))
- `geo_ip_not_match` (Block List) package: yandex.cloud.smartcaptcha.v1
filename: yandex/cloud/smartcaptcha/v1/captcha.proto (see [below for nested schema](#nestedblock--security_rule--condition--source_ip--geo_ip_not_match))
- `ip_ranges_match` (Block List) package: yandex.cloud.smartcaptcha.v1
filename: yandex/cloud/smartcaptcha/v1/captcha.proto (see [below for nested schema](#nestedblock--security_rule--condition--source_ip--ip_ranges_match))
- `ip_ranges_not_match` (Block List) package: yandex.cloud.smartcaptcha.v1
filename: yandex/cloud/smartcaptcha/v1/captcha.proto (see [below for nested schema](#nestedblock--security_rule--condition--source_ip--ip_ranges_not_match))
...
- `path` (Block List) Path of the URI [RFC3986](https://datatracker.ietf.org/doc/html/rfc3986#section-3.3). (see [below for nested schema](#nestedblock--security_rule--condition--uri--path))
- `queries` (Block List) List of query matchers. AND semantics implied. (see [below for nested schema](#nestedblock--security_rule--condition--uri--queries))
...
- `value` (Block List) Value of the query parameter. (see [below for nested schema](#nestedblock--security_rule--condition--uri--queries--value))
