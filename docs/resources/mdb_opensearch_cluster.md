...
- `config` (Attributes) OpenSearch server configuration settings. (see [below for nested schema](#nestedatt--config--opensearch--config))
...
<a id="nestedatt--config--opensearch--config"></a>
### Nested Schema for `config.opensearch.config`
