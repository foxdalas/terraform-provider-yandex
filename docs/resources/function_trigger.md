...
- `log_group` (Block List, Max: 1) Deprecated Logging settings definition for Yandex Cloud Functions Trigger. Please, use logging instead. (see [below for nested schema](#nestedblock--log_group))
...
- `batch_cutoff` (String) Batch Duration in seconds for Yandex Cloud Functions Trigger.
- `log_group_ids` (Set of String) Log group IDs for Yandex Cloud Functions Trigger.
